...
--
-- Table structure for table `recent_deals`
--

DROP TABLE IF EXISTS `recent_deals`;
...
CREATE TABLE `recent_deals` (
  ...
  `recent_deal_date` varchar(17) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
